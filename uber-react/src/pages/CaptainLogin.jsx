    ...
    return (
        <div>
            <div className="container p-4 d-flex flex-column justify-content-between vh-100">
                ...
                <p className="text-center mt-3">Join a fleet? <Link to="/captain-signup" className="link-underline link-underline-opacity-0 fw-medium">Register as a Captain</Link>
                </p>
                </div>
                <div className="mb-4">
                <Link to='/login' type="submit" style={{backgroundColor: "#d46416"}} className="btn btn-success w-100 fw-medium">
                    Signin as User
                </Link>
                </div>
            </div>
